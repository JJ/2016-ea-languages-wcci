...
In this paper, 15 languages have been chosen for performing all
...
\begin{table*}[h!tb]
    ...
    \begin{tabular}{l|c|l|l|l}
      ...
      C\# & 4.8.4 & \url{https://git.io/vzHif} & Bit Vector  & Compiled\\
      Clojure & 1.8.0 & \url{https://git.io/vzHif} & Persistent Vector &  Interpreted \\ 
      Common Lisp & 0.13.7 & \url{https://git.io/vzHif} & Simple Bit Vector &  Compiled\\ 
...
%
    ...
    interpreted. 
    Compiled languages are represented by Haskell, Rust, Scala, Java, Common Lisp, Clojure, Go, C, C\# and
...
designed for the Common Language Infrastructure.  In recent
versions C# has added several major features to accommodate functional-style programming, 
and dynamic binding. For this work the c\# was compiled to run in the Mono runtime, an 
implementation of the ECMA Common Language Infrastructure (CLI).
...
These languages will be tested against a set of interpreted languages described below.
