...
\begin{abstract}
  ...
  %   As performance metric, the speed for both popular and not so popular computer languages has been used.
  ...
  Besides, these experiments show which of these measures are,  % "measures" ? 
