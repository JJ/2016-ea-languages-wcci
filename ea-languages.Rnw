...
and are available in the same repository as this paper, together
...
Python are faster than Scala. Perl is one of the slowest, but the {\em simple}
...
structure is faster than Julia, and less than 1 the opposite. Please check the
...
PROY-PP2015-06 (Plan Propio 2015 UGR) and project V17-2015 of the Microprojects 
