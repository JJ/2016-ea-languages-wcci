...
not too big; besides, PHP, largely not considered a general-purpose
language, is indeed the fastest in some of the tests. 

All these tests lead us to the conclusion that there is no language
that is superior to all others across all sizes and problems
considered. There is no free lunch also in the implementation in
