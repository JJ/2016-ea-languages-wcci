...
independent of the length. These are C, C\# and Java, a fact that can be
...
architectures. Also a repository in GitHub, could host different implementations
and other members of the EA community could participate with ideas and
best practices can be documented and discussed.
